...
use App\Controller\HistoricMemoriesEvents;
 ...
 * @ORM\Entity(repositoryClass="App\Repository\HistoricEventsRepository")
 */
#[ApiResource(
    collectionOperations: [
        ...
        'get_memories_events' => [
            'method' => 'GET',
            'path' => '/historic_memories_events',
            'controller' => HistoricMemoriesEvents::class
        ],
    ],
    itemOperations: ['get'],
)]
