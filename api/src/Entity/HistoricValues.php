...
use App\Controller\HistoricValuesController;
 ...
 * @ORM\Entity(repositoryClass="App\Repository\HistoricValuesRepository")
 */
#[
    ApiResource(
        ...
        'get_values' => [
            'method' => 'GET',
            'path' => '/get_values/{id}',
            'controller' => HistoricValuesController::class,
        ],
    ],
        itemOperations: ['get'],
    )]
